	...
	<div class="container">
		...
		<div class="main">
			...
			<div class="right"> 
              ...
              <td bgcolor="#FFFFFF">
              	<input type="text" name="auctionGuide.guideTitle" id="guideTitle" maxlength="50" size="50" />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF">
              	<textarea name="auctionGuide.guideContent" rows="20" cols="180" style="width:100%;height:200px"></textarea>
              </td>
            </tr> 
		...
		function doSubmit(){
			...
			if(confirm("是否提交该拍卖指南")){
				document.forms[0].target = "_self";
			 	document.forms[0].action="adminManage_guideSave";
