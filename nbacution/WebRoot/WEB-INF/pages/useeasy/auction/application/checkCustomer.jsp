...
<script type="text/javascript"  language="javascript">
	location.href="guestApplication_customerWait?auctionFlag=" + $("#auctionFlag").val();
</script>
</s:if>
<s:if test="#request.bidderFlag == 2">
<script type="text/javascript"  language="javascript">
	location.href="guestApplication_customer?auctionFlag=" + $("#auctionFlag").val();
</script>
</s:if>
...
<div class="content">
	...
	<div class="line"></div>
	<div class="bg">
		<div id="mess_sec" style="display:none">尊敬的用户，您不能进入该场拍卖会~~</div>
