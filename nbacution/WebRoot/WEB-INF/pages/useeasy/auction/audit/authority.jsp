...
<!--container-->
	<div class="container">
		...
		<div class="main">
            ...
            <tr>
              <td  align="right" bgcolor="#FFFFFF"><font color="red">*</font>拍牌号</td>
              <td bgcolor="#FFFFFF" colspan="3">
              <input type="text" id="bidNum" name="bidNum" size="20" maxlength="20"/>
            </td>
            </tr>
            <tr>
              <td  align="right" bgcolor="#FFFFFF"><font color="red">*</font>保证金</td>
              <td bgcolor="#FFFFFF" colspan="3">
            ...
            <tr>
              ...
              <s:iterator value="auctionTeamType_list" var="teamType_list">
              		<input type="checkbox" id="teamFlag" class="groupclass" name="teamFlag" value="<s:property value="#teamType_list.id"/>"/><s:property value="#teamType_list.teamType"/><br/>
              </s:iterator>
...
<script language="javascript" type="text/javascript">
	function doSubmit(str){
		...
		var bidNum = $("#bidNum").val();
		var bidNum_pattern = new RegExp("^[1-9]{1,1}[0-9]{0,9}$");
		if(!bidNum_pattern.test(bidNum)){
			$("#bidNum").focus();
			alert("拍牌号为整数！");
			return;
		}
		...
		if(confirm("是否通过该申请！")){
			document.forms[0].action = "companyAudit_doAuthority?applyFlag="+str+"&boxesFlag="+boxes;
