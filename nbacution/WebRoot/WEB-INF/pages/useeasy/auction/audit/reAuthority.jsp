...
<!--container-->
	<div class="container">
		...
		<div class="main">
          ...
          <!--<input type="hidden" id="auctionMarginLevelFir_val" value="<s:property value="auctionInfo.auctionMarginLevelFir"/>"/>
          <input type="hidden" id="auctionMarginMax_val" value="<s:property value="auctionInfo.auctionMarginMax"/>"/>-->
          </form>
...
<script language="javascript" type="text/javascript">
	function doSubmit(str){
		...
		if(confirm("是否重新审核该申请！")){
			document.forms[0].action = "companyAudit_doReAuthority?applyFlag="+str;
