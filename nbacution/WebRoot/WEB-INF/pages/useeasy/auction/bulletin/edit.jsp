	...
	<div class="container">
		...
		<div class="main">
			...
			<div class="right"> 
              ...
              <input type="text" id="auctionName" name="auctionBulletin.auctionName" size="50" maxlength="50" value="<s:property value="auctionBulletin.auctionName"/>"/>
              </td>
            </tr>
			...
			<tr>
              ...
              <td bgcolor="#ffffff">
              	<select id="auctionForm" name="auctionBulletin.auctionForm">
              				<s:if test="auctionBulletin.auctionForm == 1">
              					<option value="0">请选择</option>
								<option value="1" selected="selected">现场拍卖</option>
								<option value="2">网络同步拍卖</option>
              				</s:if>
              				<s:elseif test="auctionBulletin.auctionForm == 2">
              					<option value="0">请选择</option>
								<option value="1">现场拍卖</option>
								<option value="2" selected="selected">网络同步拍卖</option>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF">
              <input type="text" id="sortFlag" name="auctionBulletin.sortFlag"  size="50" maxlength="20" value="<s:property value="auctionBulletin.sortFlag"/>"/>
              </td>
            </tr>
            <tr>
              <td align="right" bgcolor="#FFFFFF"><span style="color:red">*</span>超链接路径</td>
              <td bgcolor="#FFFFFF">
              <input type="text" id="connectionUrl" name="auctionBulletin.connectionUrl"  size="50" maxlength="100" value="<s:property value="auctionBulletin.connectionUrl"/>"/>
              </td>
            </tr>
...
function doSubmit(){
	...
	var sortFlag_pattern = new RegExp("^[0-9]{1,10}$");
	...
	if(confirm("是否提交该拍卖会公告")){
		document.forms[0].target = "_self";
	 	document.forms[0].action="companyBulletin_modify";
