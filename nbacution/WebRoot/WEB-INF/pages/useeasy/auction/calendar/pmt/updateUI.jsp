...
<html>
  ...
  <body>
	...
	<div class="container">
       ...
       <form action="pmtingAction_update" method="post">
          <table   width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#eed09c" id="table1">
         <tr>
            <td bgcolor="#FFFFFF" align="center">
            <input type="hidden" value="<s:property value="#request.pmt.id"/>" name="pmt.id"/> 
                               拍卖厅名称
            </td>
            <td bgcolor="#FFFFFF" align="center"><input type="text" name="pmt.pmtName" value="<s:property value="#request.pmt.pmtName"/>"/></td>
         </tr>
         
          <tr>
            <td bgcolor="#FFFFFF" align="center">备注</td>
            <td bgcolor="#FFFFFF" align="center"><input type="text" name="pmt.notice" value="<s:property value="#request.pmt.notice"/>"/></td>
         </tr>
       ...
       <tr><td colspan=2 bgcolor="#FFFFFF" align="center">
           ...
           <s:iterator value="#request.userTime" var="u" status="flag">
             ...
             <input type="checkbox"  
              ...
              <s:iterator   value="#request.pmt.ut" var="uu">
                 <s:if test="#u.id==#uu.id"> checked="checked"  </s:if>
                
              </s:iterator>
             
             
            name="ut.makeNew[<s:property value="#flag.index"/>].id" value="<s:property value="#u.id"/>"/> <s:property value="#u.useTime"/>
          </s:iterator>
        </td>
       </tr>
       <tr>
