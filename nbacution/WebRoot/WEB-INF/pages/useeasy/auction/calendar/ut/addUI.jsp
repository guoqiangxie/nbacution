  ...
  <center>
	...
	<div class="container">
		...
		<div class="main">
			...
			<div class="right"> 
	  			<div class="tit">
  				<div class="l">增加拍卖厅使用时间</div> 
	  			<div class="r">
	  			 <a style="color:blue; font-weight:bold;"  href="utAction_getList" align="center">【返回拍卖厅使用时间列表】</a> 
	  			</div>
	  			</div> 
       ...
       <form action="utAction_add" method="post">
          <table   width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#eed09c" id="table1">
         <tr>
            <td bgcolor="#FFFFFF" align="center">时间</td>
            <td bgcolor="#FFFFFF" align="center"><input type="text" name="utime.useTime"/></td>
         </tr>
         
          <tr>
            <td bgcolor="#FFFFFF" align="center">备注</td>
            <td bgcolor="#FFFFFF" align="center"><input type="text" name="utime.notice"/></td>
         </tr>
