...
window.onload = function(){	
  ...
  <center>
	...
	<div class="container">
      ...
      <form action="businessAction_update" method="post">
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#eed09c" id="table1">
         <tr>
             <td bgcolor="#FFFFFF" >标题</td>
              <td bgcolor="#FFFFFF" >
                  <input type="hidden" value="<s:property value="#request.update.id"/>" name="id"/>
                  <input size="70" type="text" name="title" value="<s:property value="#request.update.title"/>"/>
               </td>
          </tr>
           ...
           <tr>
             <td bgcolor="#FFFFFF" >标题图片 </td>
              <td bgcolor="#FFFFFF" >
                     <table>
                        <tr>
                           <td> <input type="text" id="url1"  name="imgPath"  value="<s:property value="#request.update.imgPath"/>"></td>
                           ...
                           <td>
                             <s:if test="#request.update.imgPath !=null"> <img src="<s:property value="#request.update.imgPath"/>" id="gpwimgshow" width="150px" height="150px"  /></s:if>
                             <img src="" id="gpwimg1" width="150px" height="150px" style="display:none"/>
                            </td>
            ...
            <td bgcolor="#FFFFFF" >正文</td>
             <td bgcolor="#FFFFFF" >
             	<textarea  name="content" >
             	   <s:property value="#request.update.content"/>
             	</textarea>
            </td>
         </tr>
