	...
	<div class="container">
		...
		<div class="main">
			...
			<div class="right"> 
              ...
              <td bgcolor="#FFFFFF">
              	<input type="password" name="accountPass" id="accountPass" maxlength="20" size="50" />
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF">
              	<input type="password" name="" id="accountNewPass" maxlength="20" size="50" />
              	<span><font color="red">(请输入数字，字母,至少3位)</font></span>
              </td>
            </tr>
            <tr>
              ...
              <td bgcolor="#FFFFFF">
              	<input type="password" name="accountConfirmPass" id="accountConfirmPass" maxlength="20" size="50" />
              	<span><font color="red">(请输入数字，字母,至少3位)</font></span>
              </td>
            </tr>
            <tr>
