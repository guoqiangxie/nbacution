	        ...
	        <s:if test="#request.isSettlement == 0">
				...
				<tr>
	            	<td align="center" colspan="9">
	            		...
	            		<input class=large_btn  type=button value="结算 " onclick="doSubmit(<s:property value="#request.applicationInfo.id"/>);" />
	            	</td>
	            </tr>
...
function doSubmit(str){
	...
	if(confirm("是否结算货款，金额为： " + goods_flag + " ！")){
		document.forms[0].target = "_self";
	 	document.forms[0].action="companyFinance_settlement?applyFlag="+str
	 				+"&goodsVal="+goods_flag;
