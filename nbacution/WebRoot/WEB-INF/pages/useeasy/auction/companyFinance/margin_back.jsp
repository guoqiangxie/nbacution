		...
		<div class="main">
			...
			<div class="right"> 
	  			<div class="tit">
	  				...
	  				<div class="r"><a style="color:blue; font-weight:bold;"  href="companyFinance_index?auctionFlag=<s:property value="#request.auctionInfo.id"/>">【返回】</a> 
	  				</div>
        	...
        	<input type="hidden" id="orderDate_val" value="<s:property value="#request.orderDate"/>"/>
	  		...
	  		<tr>
	  			<td colspan="9" bgcolor="#FFFFFF">
	  				账号名称：<s:property value="#request.applicationInfo.accountName"/><br />
		  			拍牌号：<s:property value="#request.applicationInfo.bidNum"/><br />
	        		...
	        		现场支付：<font color="red"><s:property value="#request.aliveMargin"/></font>
              		...
              		退还保证金：<font color="red"><s:property value="#request.backMargin"/></font>
              		<br />
            ...
            <s:iterator value="item_list" var="iInfo_list" status="status">
	        	...
	        	<tr>
	            	<td align="center" colspan="9">
	            		退还保证金金额：<input type="text" id="backMargin_val" value="" size="15" maxlength="15"/>
				...
				<tr>
	            	<td align="center" colspan="9">
	            		...
	            		<input class=large_btn  type=button value="退还保证金 " onclick="doSubmit(<s:property value="#request.applicationInfo.id"/>);" />
	            	</td>
	            </tr>
...
function doSubmit(str){
	var backMargin_val = $("#backMargin_val").val();
	var backMargin_val_pattern = new RegExp("^[1-9]{1,1}[0-9]{0,9}$");
	if(!backMargin_val_pattern.test(backMargin_val)){
		$("#backMargin_val").focus();
		alert("最大保证金为整数！");
		return;
	}
	
	if(confirm("是否退还保证金，金额为： " + backMargin_val + " ！")){
		document.forms[0].target = "_self";
	 	document.forms[0].action="companyFinance_marginDoBack?applyFlag="+str
	 				+"&marginVal="+backMargin_val;
