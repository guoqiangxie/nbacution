	...
	<div class="header">
		...
		<div class="mainnav">
			<ul>
				...
				<li class="out"><a href="companyIndex_bulletin?pageNo=1&companyId=<s:property value="#request.auctionCompany.id" />"><span>拍卖公告</span></a></li>
	...
	<div class="main">
		...
		<div class="right">
			<div class="sidebar">
				...
				<div class="wrap">
					<div class="inside">
				    <table id="table1" valign="top" align="center" width="98%" class="from back">	
							 <%@include  file="/WEB-INF/pages/useeasy/auction/notice/getGGList.jsp"%>  
