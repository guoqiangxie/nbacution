	...
	<div class="header">
		...
		<div class="mainnav">
			<ul>
				...
				<li class="out"><a href="companyIndex_connection?companyId=<s:property value="#request.auctionCompany.id" />"><span>联系我们</span></a></li>
			</ul>
		</div>
		<div class="msg">
			...
			<div class="sidebar">
				...
				<div class="wrap">
				    ...
				    <table width="660" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                      <tr>
                        <td height="154">
                          <s:property value="#request.auctionCompany.companyConnection" escape="false"/>
                        </td>
                      </tr>
                    </table>
				  </div>
