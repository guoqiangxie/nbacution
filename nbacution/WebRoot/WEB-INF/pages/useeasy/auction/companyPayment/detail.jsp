		...
		<div class="main">
			...
			<div class="right"> 
	  			<div class="tit">
	  				...
	  				<div class="r"><a style="color:blue; font-weight:bold;"  href="companyPayment_index?currentPage=1">【返回】</a> 
	  				</div>
            ...
            <tr align="center">
              <td width="10%" bgcolor="#FFFFFF">账号</td>
              <td width="10%" bgcolor="#FFFFFF">姓名</td>
              <td width="10%" bgcolor="#FFFFFF">身份证</td>
            ...
            <s:iterator value="marginFinance_list" var="mFinance_list" status="status">
         		<tr align="center" id="">
					<td bgcolor="#FFFFFF"><s:property value="#mFinance_list.accountName"/></td>
					<td bgcolor="#FFFFFF"><s:property value="#mFinance_list.guestName"/></td>
					<td bgcolor="#FFFFFF"><s:property value="#mFinance_list.guestIdentityCard"/></td>
					<td bgcolor="#FFFFFF"><s:property value="#mFinance_list.guestPhone"/></td>
	              	<td bgcolor="#FFFFFF"><s:date name="#mFinance_list.createTime" /></td>
				  	<td bgcolor="#FFFFFF">
				  	<s:if test="#mFinance_list.marginType == 3">
				  	-<s:property value="#mFinance_list.marginVal"/>
				  	</s:if>
				  	<s:else>
				  	<s:property value="#mFinance_list.marginVal"/>
				  	</s:else>
				  	...
				  	<td bgcolor="#FFFFFF">
					  	...
					  	<s:elseif test="#mFinance_list.marginType == 3">
					  	现场退款
					  	</s:elseif>
					</td>
					<td bgcolor="#FFFFFF">
            ...
            <s:iterator value="goodsFinance_list" var="gFinance_list" status="status">
         		<tr align="center" id="">
					<td bgcolor="#FFFFFF"><s:property value="#gFinance_list.accountName"/></td>
					<td bgcolor="#FFFFFF"><s:property value="#gFinance_list.guestName"/></td>
					<td bgcolor="#FFFFFF"><s:property value="#gFinance_list.guestIdentityCard"/></td>
					<td bgcolor="#FFFFFF"><s:property value="#gFinance_list.guestPhone"/></td>
