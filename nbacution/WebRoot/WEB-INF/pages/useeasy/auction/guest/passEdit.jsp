...
<script type="text/javascript" src="useeasy/auction/js/guest/passEdit.js" language="javascript"></script>
	...
	<div class="container">
		...
		<div class="main">
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF">
              	<input type="password" name="" id="accountNewPass" maxlength="50" size="50" value=""/>
              	<span><font color="red">(请输入数字，字母,至少3位)</font></span>
              </td>
            </tr>
            <tr>
