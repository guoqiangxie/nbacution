...
<!--container-->
	<div class="container">
		...
		<div class="main">
            ...
            <s:iterator value="applyInfoFinance_list" var="appInfoFinance_list">
		            <tr align="center">
						<td bgcolor="#FFFFFF"><s:property value="#appInfoFinance_list.auctionName"/></td>
		              	<td bgcolor="#FFFFFF"><s:property value="#appInfoFinance_list.companyName"/></td>
					  <td bgcolor="#FFFFFF"><s:date name="#appInfoFinance_list.createTime" format="yyyy-MM-dd HH:mm"/></td>
					  <td bgcolor="#FFFFFF" class="state">
					  	<s:if test="#appInfoFinance_list.auctionStatus == 0">
            				尚未开始<br/>
            				<a href="guestFinance_detail?auctionFlag=<s:property value="#appInfoFinance_list.auctionId"/>"><font color="red">查看支付信息</font></a>
            			</s:if>
            			<s:elseif test="#appInfoFinance_list.auctionStatus == 1">
            				正在进行<br/>
            				<a href="guestFinance_detail?auctionFlag=<s:property value="#appInfoFinance_list.auctionId"/>"><font color="red">查看支付信息</font></a>
            			</s:elseif>
            			<s:elseif test="#appInfoFinance_list.auctionStatus == 2">
            				已经结束<br/>
            				<a href="guestFinance_detail?auctionFlag=<s:property value="#appInfoFinance_list.auctionId"/>"><font color="red">查看支付信息</font></a>
            			</s:elseif>
					  </td>
