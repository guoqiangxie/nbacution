...
<title>宁波市在线同步拍卖交易平台--文物艺术品拍卖会频道</title>
...
$(document).ready(function(){
	...
	$("#art").removeAttr("class").addClass("out");
	...
	<div class="container">
		...
		<!--end banner-->
				<div class="sidebar">
					...
					<div class="title">
						<span class="text"><img src="useeasy/auction/images/main/title_wwysp.gif" /></span>
						<span class="more"></span>
					</div>
						...
						<div class="inside min-height">
							<div class="nav" >
								<ul>
									...
									<li><a href="auctionIndex_index?searchKind=7&searchType=1&currentPage=1"><img id="img1" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										进行中拍卖会 </a>
									</li>
									</s:if>
									<s:else>
									...
									<li><a href="auctionIndex_index?searchKind=7&searchType=2&currentPage=1"><img id="img2" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										今天的拍卖会</a>
									</li>
									</s:if>
									<s:else>
									...
									<li><a href="auctionIndex_index?searchKind=7&searchType=3&currentPage=1"><img id="img3" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										近期的拍卖会</a>
									</li>
									</s:if>
									<s:else>
									...
									<li><a href="auctionIndex_index?searchKind=7&searchType=4&currentPage=1"><img id="img4" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										已结束拍卖会</a>
									</li>
									</s:if>
									<s:else>
