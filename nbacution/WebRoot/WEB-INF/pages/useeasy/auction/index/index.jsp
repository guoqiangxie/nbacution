...
$(document).ready(function(){
	$("#index").removeAttr("class").addClass("out");
	...
	<div class="container">
		...
		<div class="main">
			...
			<div class="left">
				...
				<jsp:include page="../main/bid1.jsp" flush="true" />
		        	<div class="sidebar">
					 <div class="title">
						<span class="text">行业动态<!--<img src="useeasy/auction/images/main/tit_hydt.gif" width="100%" height="40"></img>--></span>
						<span class="more"> <a href="auctionIndexVocationnews_indexquery"> 更多>></a></span>
					</div>
				     <%@include  file="/WEB-INF/pages/useeasy/auction/vocation/indexshow.jsp"%>
			        </div>	
				<div class="sidebar">
					<div class="title">
			...
			<div id="right" class="right" >
		        ...
		        <div class="sidebar">
					...
					<div class="title">
						<span class="text"><img src="useeasy/auction/images/main/right_tit.gif" /></span>
						<span class="more"></span>
					</div>
					
					<div class="wrap">
						<div class="inside min-height01">
							<div class="nav" >
								<ul>
									<li class="t">排序方式：</li>
									<s:if test="#request.searchType != 1">
									<li><a href="auctionIndex_index?searchKind=1&searchType=1&currentPage=1"><img id="img1" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										进行中拍卖会 </a>
									</li>
									</s:if>
									<s:else>
									...
									<li><a href="auctionIndex_index?searchKind=1&searchType=2&currentPage=1"><img id="img2" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										今天的拍卖会</a>
									</li>
									</s:if>
									<s:else>
									...
									<li><a href="auctionIndex_index?searchKind=1&searchType=3&currentPage=1"><img id="img3" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										近期的拍卖会</a>
									</li>
									</s:if>
									<s:else>
									...
									<li><a href="auctionIndex_index?searchKind=1&searchType=4&currentPage=1"><img id="img4" src="useeasy/auction/images/main/icon03.gif" class="icon" />
										已结束拍卖会</a>
									</li>
									</s:if>
									<s:else>
				...
				<div class="sidebar">					
					<div class="title">
						<span class="text"><img src="useeasy/auction/images/main/tit_pmgg.gif" /></span>
						<span class="more"><a href="noticeAction_geAll">更多>></a></span>
					</div>
					
					<div class="wrap">
						<div class="inside min-height02">						
							<!-- 公告 -->
			                    <%@include  file="/WEB-INF/pages/useeasy/auction/notice/showIndex.jsp"%>		 
						</div> 
					</div>
				 	...
				 	<div class="sidebar">					
					 <div class="title">
				          <span class="text"><img src="/useeasy/auction/images/tit_pmhxx.gif"/></span>
				          <span class="more"><a href="auctionIndexManager_query_all">更多>></a></span>
			         </div>
					<div class="wrap">
						<div class="inside min-height03">						
							 <!-- 拍卖信息 -->
			                   <%@include  file="/WEB-INF/pages/useeasy/auction/message/showIndex.jsp"%>		 
						</div> 
					</div>
		...
		<div class="biao">
			<div class="title">
				...
				<span class="more"><a href="businessAction_getIndexList">更多>>></a></span>
			</div>
			<div class="wrap">
			  <!-- 拍卖招商 -->
			  <jsp:include page="/WEB-INF/pages/useeasy/auction/canvass_business/getIndexListsix.jsp" flush="true" />
			</div>
			<div class="bottom"></div>
		</div>
		
		<!-- 招商/WEB-INF/pages/useeasy/auction/vocation/indexlonymessage.jsp -->
