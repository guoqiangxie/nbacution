...
<body> 
	...
	<div class="container">
		...
		<div class="main">
			...
			<div id="right" class="right_s" >
				<div class="sidebar">
					...
					<div class="title">
						<span class="text"><img src="useeasy/auction/images/main/tit_ggcx.gif" /></span>
     ...
     <s:iterator value="#request.type_list" var="list">
     <tr>
          <td>
 ...
 <td><a    href="auctionIndexManager_queryid?id=<s:property value="#list.id"/>  ">详情进入 </a></td></tr>
                  ...
                  <pmh:pageTag gotoURI="auctionIndexManager_querytype" pageSize="${requestScope.pageSize}"></pmh:pageTag>                   
              </center>  
		 </div>
