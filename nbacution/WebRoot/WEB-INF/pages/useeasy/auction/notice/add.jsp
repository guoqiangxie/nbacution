        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#eed09c" id="table1">
          ...
          <tr> 
             <td bgcolor="#FFFFFF">电话</td>
              <td bgcolor="#FFFFFF"><input  size="50" type="text" id="phone" name="notice.phone" maxlength="20"/></td>
               <td style="color:red" bgcolor="#FFFFFF">  <s:fielderror fieldName="notice.phone"></s:fielderror></td>
           </tr>   
         <tr> 
             <td bgcolor="#FFFFFF">拍卖时间</td>
              <td bgcolor="#FFFFFF"><input  size="50" maxlength="30" type="text" id="title" name="notice.createtime" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-%d %H:%m'})"/></td>
                <td style="color:red" bgcolor="#FFFFFF">  <s:fielderror fieldName="notice.createtime"></s:fielderror></td>
           </tr>  
           
          <tr>    
             <td bgcolor="#FFFFFF">拍卖会名称</td>
              <td bgcolor="#FFFFFF"><input  size="50" type="text" id="cpy" name="notice.pmhName" maxlength="100"/></td>
               <td style="color:red" bgcolor="#FFFFFF">  <s:fielderror fieldName="notice.pmhName"></s:fielderror></td>
           </tr>   
           <tr>    
             <td bgcolor="#FFFFFF">公告类型</td>
               <td bgcolor="#FFFFFF">
                    <select name=notice.notice_type>
                          <option value="1">房地产</option><option  value="2">艺术品</option>
                          <option  value="3">民品</option>
                          <option  value="4">机动车</option><option  value="5">物资设备</option>
                          <option  value="6">股权</option>
                          <option  value="7">其他</option></select>
          ...
          <tr>    
             <td bgcolor="#FFFFFF">公告内容</td>
              <td bgcolor="#FFFFFF" colspan=2><textarea name="notice.notice_content" cols="10" rows="10" ></textarea></td>
                  <s:fielderror fieldName="notice.notice_content"></s:fielderror> 
          </tr>
    </table>
