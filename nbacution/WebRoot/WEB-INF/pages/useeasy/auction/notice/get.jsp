...
<body> 
	...
	<div class="container">
		...
		<div class="hydt">
			<div><h1> <s:property value="#request.notice.title" /></h1></div>
			<div class="note"> <s:property value="#request.notice.company" />  </div>
			<div class="content">
			 <s:property value="#request.notice.notice_content" escape="false" />
			</div>
		</div>
