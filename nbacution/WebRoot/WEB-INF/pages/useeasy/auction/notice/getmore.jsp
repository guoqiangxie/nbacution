			...
			<div id="right" class="right_s" >
             ...
             <tr>
               <td title="<s:property value="#list.title"/>">
                 ...
                 <td>
                  <s:if test="#list.pmhName.length()>30"> <a   title="拍卖公告" href="noticeAction_get?id=<s:property value='#list.id'/>  "><s:property value="#list.pmhName.substring(0,30)"/>...</a></s:if>
                  <s:else>
                    <a  title="拍卖公告" href="noticeAction_get?id=<s:property value='#list.id'/> "><s:property value="#list.pmhName"/></a>
                  </s:else>
                 ...
                 <td> <s:select theme="simple"  disabled="true" list="#{'1':'房地产','2':'艺术品','3':'民品','4':'机动车','5':'物资设备','6':'股权','7':'其他'}" listKey="key" listValue="value" value="#list.notice_type"></s:select></td>
                              ...
                              <pmh:pageTag gotoURI="noticeAction_geAll" pageSize="${requestScope.pageSize}"></pmh:pageTag>    
                               </center>  
							</div>
