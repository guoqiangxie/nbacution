...
<script type="text/javascript" src="useeasy/auction/js/recoverPass/phone.js" language="javascript"></script>
<title>宁波市在线同步拍卖交易平台--手机找回密码</title>
...
<div class="container">
	...
	<div class="main">
		...
		<div class="left">
			<ul>
			<li><span>手机找回密码</span></li>
			<li><a href="recoverPassManage_email">邮箱找回密码</a></li>
			</ul>
		</div>
		<!--end left-->
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#eed09c">
			...
			<tr>
              	<td bgcolor="#FFFFFF" align="right"><font color="red">*</font> 短信密码:</td>
              	<td bgcolor="#FFFFFF">
                	<input name="passcode" id="passcode" type="password" maxlength="6" size="6" tabindex="3"/>
                 	<span id="getPass_div">
                 	<a href="###" onclick="sendPhonePass();" ><font color="red">获取短信密码</font></a>
                 	</span>
                 	<span id="getPass_mes">
        ...
        <p>温馨提示：<br/>
        	 账号名+短信密码<br/>
        	1、获取短信密码：请您输入所要的账号名，验证码，点击“<font color="red">获取短信密码</font>”，<br/>
         	您的手机将收到短信临时密码（六位数字，当日内有效），凭此临时密码进行身份验证。<br/>
         	如您没有收到随机短信密码，请稍等片刻后重新点击“<font color="red">获取短信密码</font>”，系统将为您进行重发，请确保您的手机正常接收短信。<br/>
         	2、系统登录：请您输入所要的账号名，验证码以及获取的短信密码，点击“登录”即可登录账号管理进行密码设置。<br/>
         	3、每天最多发送3次短信密码。
        </p>
	    </div>
		<!--end right-->
	...
	<script language="javascript" type="text/javascript">
		$("#validationImage").attr("src","validationCode_recoverPassPhone");
	</script>
