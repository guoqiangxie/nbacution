		...
		<div class="main">
			...
			<div id="right" class="right_s" >
				<div class="sidebar">
					...
					<div class="title">
						<span class="text"><img src="useeasy/auction/images/main/tit_hydt.gif" /></span>
	    	...
	    	<table class="infoList01" width="100%" >
              <tr>
                 ...
                 <td>详情进入</td>
                    ...
                    <s:iterator value="#request.vocation_index_gall" var="list">
                     <tr>
                     <td>
                        <s:if test="#list.vnewstitle.length()>20">
                            <s:property value="#list.vnewstitle.substring(0,20)"/> ...
                        </s:if>
                        <s:else>
                      ...
                      <td>
                         <s:date name="#list.vnewsdate" format="yyyy-MM-dd"/>
                     </td>
                     <td>[<s:property value="#list.vnewsviewtime" />]</td>
                     <td>
                         <a href="auctionIndexVocationnews_indexsilgevocation?id=<s:property value="#list.vnewsid"/> ">详情进入</a>
                     </td>
                   ...
                   <pmh:pageTag gotoURI="auctionIndexVocationnews_indexquery" pageSize="${requestScope.pageSize}"></pmh:pageTag>              
              </center>  
		 </div>
