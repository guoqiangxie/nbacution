...
<body> 
	...
	<div class="container">
		...
		<div class="hydt">
			<div><h1> <s:property value="#list.vnewstitle"/></h1></div>
			<div class="note">时间：<s:date name="#list.vnewsdate" format="yyyy-MM-dd HH:MM"/>&nbsp;&nbsp; 点击率：<s:property value="#list.vnewsviewtime"/>次  </div>
			<div class="content">
			    <s:if test="#list.vnewsimagepath != null">
			      <img src="<s:property value="#list.vnewsimagepath"/>"/>
			      <br/>
			    </s:if>
			   <s:property value="#list.vnewscontent" escape="false"/>
			</div>
		</div>
		</s:iterator>					 
