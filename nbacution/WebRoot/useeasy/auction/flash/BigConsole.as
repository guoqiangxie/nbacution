package {
	...
	public class BigConsole extends MovieClip {
		...
		public function startLoadXml(e:TimerEvent):void{
			...
			sendMessage("90", (auction_id + "&" + account_id + "&bc&" + auction_num + "&"));
		}
		...
		private function setTitleArea(){
			...
			if(item_status == "0"){
				itemCurrentPrice.htmlText = "<b><font color='#FFF000' size='96'>0</font></b>";
