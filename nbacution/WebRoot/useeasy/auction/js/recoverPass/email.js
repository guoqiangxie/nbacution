$(document).ready(function(){
	...
	$("#validationImage").click(function(){  
		$("#validationImage").attr("src","validationCode_recoverPassEmail?t="+Math.random());
	});
});
...
function sendEmailPass(){
	...
	document.forms[0].action="recoverPassManage_getEmailPass";
...
function doSubmit(){
	...
	document.forms[0].action="recoverPassManage_doEmailSubmit";
	document.forms[0].submit();
}
...
function doPassModify(){
	...
	document.forms[0].action="recoverPassManage_emailModifySubmit";
	document.forms[0].submit();
}